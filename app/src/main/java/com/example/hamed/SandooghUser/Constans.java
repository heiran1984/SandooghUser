...
public class Constans {
    ...
    public static final String URL_NEWVAM=ROOT_URL+"newVam.php";
    public static final String GET_MOJODI=ROOT_URL+"getMojodi.php";
    public static final String GET_USER=ROOT_URL+"displayUser.php";
    public static final String GET_VAM=ROOT_URL+"DisplayVam.php";
